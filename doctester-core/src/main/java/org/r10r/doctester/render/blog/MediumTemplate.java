...
/**
 * Medium blog platform template.
 *
 * Medium accepts Markdown with custom JSON headers for API integration.
 * Includes estimated reading time and publication metadata.
 */
public record MediumTemplate() implements BlogTemplate {
