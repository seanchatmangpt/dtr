...
import org.r10r.doctester.openapi.OpenApiCollector;
import org.r10r.doctester.render.LazyValue;
...
public class Java26JepIntegrationTest {
    ...
    void testJep500SealedHierarchies() {
        ...
        Class<?> authProviderClass = org.r10r.doctester.testbrowser.auth.AuthProvider.class;
        assertTrue(authProviderClass.isSealed(), "AuthProvider should be sealed");

        Class<?> renderMachineClass = org.r10r.doctester.rendermachine.RenderMachine.class;
        assertTrue(renderMachineClass.isSealed(), "RenderMachine should be sealed");

        Class<?> compilerStrategyClass = org.r10r.doctester.rendermachine.latex.CompilerStrategy.class;
        assertTrue(compilerStrategyClass.isSealed(), "CompilerStrategy should be sealed");

        Class<?> latexTemplateClass = org.r10r.doctester.rendermachine.latex.LatexTemplate.class;
