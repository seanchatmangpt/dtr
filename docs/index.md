...
DTR (Documentation Testing Runtime) is a Java 26 library that generates rich Markdown, LaTeX, HTML, and OpenAPI documentation directly from JUnit 5 tests via a declarative `say*` API.

**Version:** 2026.1.0 | **Maven:** `io.github.seanchatmangpt.dtr:dtr-core:2026.1.0` | **Java:** 26 + `--enable-preview`
...
- **Zero new dependencies** — 2026.1.0 added 14 methods with no new runtime dependencies
- **Java 26 idiomatic** — records, sealed classes, pattern matching, gatherers throughout
