...
| Guide | Task |
|---|---|
| [Advanced Rendering Formats](advanced-rendering-formats.md) | LaTeX/PDF, blog posts, HTML slides from a single test |
| [Customize HTML Output](customize-html-output.md) | Configure HTML rendering, themes, and styling options |
...
**New to DTR?** Start with the [Progressive Tutorials](../tutorials/index.md) — 6 hands-on tutorials from basics to advanced features.
