...
Slide deck render machine generating presentation slides. Converts test execution into presentation slides (Reveal.js HTML, etc.). Maps say* methods to slide content: sayNextSection → new slide, say → bullets, etc.
