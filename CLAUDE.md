...
| `.claude/skills/dx/` | `/dx` ralph-loop completion skill |
| `scripts/rust/dtr-guard/` | H-Guard semantic lie scanner |
| `scripts/rust/dtr-observatory/` | Codebase fact generator → `docs/facts/` |
| `scripts/rust/claude-code-toolkit/` | `cct` — general-purpose Claude Code toolkit |
| `docs/facts/` | ~50-token JSON agent context files |
| `.github/workflows/publish.yml` | Tag-triggered CI/CD |
