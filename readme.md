DTR [![Build Status](https://api.travis-ci.org/seanchatmangpt/dtr.svg)](https://travis-ci.org/seanchatmangpt/dtr)
=========
...
![A screenshot of the generated html output](https://github.com/seanchatmangpt/dtr/blob/master/img/dtr_example_output.png)


By default the resulting html is generated into src/target/site/dtr/


There is an integration test that uses all of dtr. Check out for a more
comprehensive example:

https://github.com/seanchatmangpt/dtr/blob/master/dtr-integration-test/src/test/java/controllers/ApiControllerDocTest.java
...
directory **target/site/dtr**. One file is named after your test.

For instance the doctest of class com.mycompany.ApiControllerDocTest will be written to a file
**target/site/dtr/com.mycompany.ApiControllerDocTest.html**.
...
You can of course skip using DTRs sayAndAssert and simply use 
...
public abstract class ArquillianDTR extends DTR {
	...
	@Override
	public org.dtr.testbrowser.Url testServerUrl() {
...
a file **/src/test/resources/org/dtr/custom_dtr_stylesheet.css**
to your project.
