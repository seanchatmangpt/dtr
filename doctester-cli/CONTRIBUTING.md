...
```bash
ruff check doctester_cli tests
ruff format doctester_cli tests
mypy doctester_cli
pytest --cov=doctester_cli
```
...
pytest --cov=doctester_cli --cov-report=html
