...
from doctester_cli.commands import convert, report, manage, publish
...
def version() -> None:
    ...
    console.print(f"DocTester CLI v{__version__}")
...
def config(
    ...
    if show:
        ...
        console.print("Use [code]doctester config --help[/code] for configuration options.")
    else:
