...
public class FormatVerificationDocTest extends DocTester {
    ...
    private void demonstratePatentTestingMethodology() {
        ...
        say("When rendering to USPTO patent format (-Ddoctester.latex.format=patent), " +
    ...
    private void demonstrateMultiFormatCapabilities() {
        ...
        sayNote("All output files are generated to target/site/doctester/ with platform-specific subdirectories.");
