...
> [!NOTE]
> Pure Java StringBuilder baseline on Java 26. A Rust implementation writing to a pre-allocated Vec<u8> will be faster. All numbers are real System.nanoTime() measurements — no simulation.
...
| Timezone | `Etc/UTC` |
| DTR Version | `2.6.0` |
| Timestamp | `2026-03-14T20:24:59.987802159Z` |
